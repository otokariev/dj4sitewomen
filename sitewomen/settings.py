...
SECRET_KEY = 'django-insecure-)(dy^(1$+^fb(m+!6u6r=z#+i-4x+6-r9ebk616h(4q_klgk6+'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['127.0.0.1']  # Разрешенные хосты
INTERNAL_IPS = ['127.0.0.1']  # Внутренние айпи адреса
...
EMAIL_USE_SSL = False
EMAIL_PORT = 587
EMAIL_HOST_USER = "aturner060@gmail.com"
EMAIL_HOST_PASSWORD = 'riqw tigq ulup ygak'
